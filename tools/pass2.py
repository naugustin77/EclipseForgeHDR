...
for nm in NAMES:
    png(imgs[nm], os.path.join(OUT, f"a tester_{nm}.png"))
png(imgs["taper"]-imgs["plain"], os.path.join(OUT, "a tester_taper_minus_plain.png"), -0.5, 0.5)
png(imgs["taper_k"]-imgs["taper"], os.path.join(OUT, "a tester_k_minus_taper.png"), -0.5, 0.5)
rr = radh[sl]
